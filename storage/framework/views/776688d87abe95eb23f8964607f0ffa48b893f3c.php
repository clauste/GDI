            ...
            <ul>
                ...
                <li class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu">
                        <ul>
                            <li>
                                <a href="<?php echo e(route('picture.index')); ?>">Picture</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('flickr')); ?>">Flickr</a>
                            </li>
                        </ul>
                    </div>
                </li>
...
</nav><?php /**PATH C:\Code\xampp\htdocs\clauste\GDI\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>